...
export default function AuthSimpleLayout({ children, title, description }: AuthLayoutProps) {
    ...
    return (
        <>
            ...
            <main id="main-content" tabIndex={-1} className="bg-background flex min-h-svh flex-col items-center justify-center gap-6 p-6 md:p-10">
                <div className="w-full max-w-sm">
                    <div className="flex flex-col gap-8">
                        ...
                        {children}
                        <p className="text-muted-foreground border-border border-t pt-5 text-center text-xs leading-5">
                            {translations.home.disclaimer}
                        </p>
                    </div>
                </div>
            </main>
